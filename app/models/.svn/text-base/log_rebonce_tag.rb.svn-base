class LogRebonceTag < ActiveRecord::Base
  ...
  def self.total(unit = "day",  date_from_str = nil, date_to_str = nil, tab = nil, order = "time",  page = 1, max = 50,  profil = nil, material_type = nil, profil_poste=nil)
  ...
  def self.by_notice(unit = "day",  date_from_str = nil, date_to_str = nil, tab = nil, order = "time",  page = 1, max = 50,  profil = nil, material_type = nil, profil_poste=nil)
    select_clause = "t.label tag_label, count(l.tag_id) total"
    from_clause = ", tags t" 
  ...
  def self.by_liste(unit = "day",  date_from_str = nil, date_to_str = nil, tab = nil, order = "time",  page = 1, max = 50,  profil = nil, material_type = nil, profil_poste=nil)
    select_clause = "t.label tag_label, count(l.tag_id) total"
    from_clause = ", tags t" 
