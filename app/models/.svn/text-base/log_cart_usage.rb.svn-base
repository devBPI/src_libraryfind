...
class LogCartUsage < ActiveRecord::Base
  ...
  def self.cart_use(unit = "day",  date_from_str = nil, date_to_str = nil, tab = nil, order = "time",  page = 1, max = 50,  profil = nil, material_type = nil, profil_poste=nil)
  ...
  def self.doc_save_in_cart(unit = "day",  date_from_str = nil, date_to_str = nil, tab = nil, order = "time",  page = 1, max = 50,  profil = nil, material_type = nil, profil_poste=nil)
    select_clause = "profil, count(id) total"
    from_clause = "" 
    where_clause = "1=1" 
    group_by_clause = "profil"
