class LogSaveNotice < ActiveRecord::Base
  ...
  def self.notice_save_total(unit = "day",  date_from_str = nil, date_to_str = nil, tab = nil, order = "time",  page = 1, max = 50,  profil = nil, material_type = nil, profil_poste=nil)
  ...
  def self.notice_save_in_list(unit = "day",  date_from_str = nil, date_to_str = nil, tab = nil, order = "time",  page = 1, max = 50,  profil = nil, material_type = nil, profil_poste=nil)
    select_clause = "profil, count(saveIn) total"
    from_clause = "" 
  ...
  def self.notice_save_mydoc(unit = "day",  date_from_str = nil, date_to_str = nil, tab = nil, order = "time",  page = 1, max = 50,  profil = nil, material_type = nil, profil_poste=nil)
    select_clause = "profil, count(saveIn) total"
    from_clause = "" 
