class LogNote < ActiveRecord::Base
  ...
  def self.note_create(unit = "day",  date_from_str = nil, date_to_str = nil, tab = nil, order = "time",  page = 1, max = 50,  profil = nil, material_type = nil, profil_poste=nil)
  ...
  def self.note_delete(unit = "day",  date_from_str = nil, date_to_str = nil, tab = nil, order = "time",  page = 1, max = 50,  profil = nil, material_type = nil, profil_poste=nil)
    select_clause = "count(id) total"
    from_clause = "" 
  ...
  def self.note_create_by_notice(unit = "day", date_from_str = nil, date_to_str = nil, tab = nil, order = "time",  page = 1, max = 50,  profil = nil, material_type = nil, profil_poste=nil)
  ...
  def self.note_delete_by_notice(unit = "day",  date_from_str = nil, date_to_str = nil, tab = nil, order = "time",  page = 1, max = 50,  profil = nil, material_type = nil, profil_poste=nil)
    select_clause = "l.object_uid notice_id, count(id) total"
    from_clause = "" 
  ...
  def self.note_create_by_liste(unit = "day",  date_from_str = nil, date_to_str = nil, tab = nil, order = "time",  page = 1, max = 50,  profil = nil, material_type = nil, profil_poste=nil)
  ...
  def self.note_delete_by_liste(unit = "day",  date_from_str = nil, date_to_str = nil, tab = nil, order = "time",  page = 1, max = 50,  profil = nil, material_type = nil, profil_poste=nil)
    select_clause = "l.object_uid liste_id, count(id) total"
    from_clause = "" 
