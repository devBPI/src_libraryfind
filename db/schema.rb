...
ActiveRecord::Schema.define(:version => 287) do
  ...
  create_table "community_users", :primary_key => "uuid", :force => true do |t|
    ...
    t.datetime "created_at",                :default => '2012-05-03 23:40:50'
    t.datetime "last_modified",             :default => '1916-05-27 13:23:08'
  end
  ...
  add_index "metadatas", ["dc_identifier_text"], :name => "index_dc_identifier"
  ...
  create_table "volumes", :force => true do |t|
    ...
    t.string  "barcode"
    t.string  "source"
    t.boolean "launchable",      :default => false
    t.string  "note",            :default => ""
    t.boolean "external_access", :default => false
  end
